...
void cv_nat_threshold(cv::Mat* mat, cv::Mat* out, double thresh, double maxval, int ttype);
void cv_nat_erode(
...
void cv_nat_resize(cv::Mat* from, cv::Mat* to, Size2i dsize, double fx, double fy, int interpolation);
